# Generated by Django 4.1 on 2022-09-14 23:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('buyout_price', models.DecimalField(decimal_places=2, max_digits=16)),
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('category', models.CharField(default='Uncategorized', max_length=32, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.AddField(
            model_name='auction',
            name='category',
            field=models.ForeignKey(default='Uncategorized', on_delete=django.db.models.deletion.SET_DEFAULT, related_name='categories', to='auctions.category'),
        ),
        migrations.AddField(
            model_name='auction',
            name='seller',
